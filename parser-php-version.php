...
if (!extension_loaded('mysql')) {
	...
	function mysql_db_query($database, $query, $link_identifier = NULL) {
		...
		if (mysqli_select_db($database, $link_identifier) !== true) {
			return false;
		}
	...
	function mysql_escape_string($unescaped_string) {
		# mysqli_escape_string = returns the escaped string
		# mysqli_real_escape_string = returns FALSE on error
	...
	function mysql_fetch_array($result, $result_type = MYSQL_BOTH) {
		...
		$temp = mysql_fetch_array($result, $result_type);
