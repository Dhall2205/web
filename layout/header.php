...
<html lang="en">
  ...
  <body>
    ...
    <a href="" class="logo" style="text-decoration: none; font-size: 14pt; font-family: verdana;">
        <img src="<?php echo $url.'assets/img/ag.png'; ?>" height="50" />
        ...
        <div id="navbar" class="navbar-collapse collapse"> 
          <ul class="nav navbar-nav navbar-right">
            <li><a href="index.php"style="color: #000; font-weight: bold;">Home</a></li>
            <li><a href="menu.php"style="color: #000; font-weight: bold;">Daftar Menu</a></li> 
            <li><a href="kontak.php"style="color: #000; font-weight: bold;">Kontak Kami</a></li> 
            <li><a href="info.php"style="color: #000; font-weight: bold;">Info Pembayaran</a></li>
            <?php if(!empty($_SESSION['iam_user'])){ ?>
			<?php 
				$user = mysql_fetch_object(mysql_query("select * from user where id='$_SESSION[iam_user]'"));
			?>
      <li><a href="pembayaran.php"style="color: #000; font-weight: bold;">Pembayaran</a></li>      
			<li class="dropdown">
				
              <a href="profile.php" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Hi <?php echo $user->nama; ?> </span></a>
              <ul class="dropdown-menu">
                <li><a href="profile.php">Profil</a></li> 
                 
              </ul>
              <li><a href="logout.php"style="color: #FFD700; font-weight: bold;">Logout</a></li> 
            </li>
			<?php }else{ ?>
			<li class="dropdown">
              <a href="login.php" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" style="color: #FFD700; font-weight: bold;">Login Sekarang </span></a>
              <ul class="dropdown-menu">
   ...
   <?php } ?>
	...
	<div class="row">
		<div class="col-md-3">
			...
			<div class="col-md-16">
				<br/>
				<img src="<?php echo $url.'assets/img/bg2.png'; ?>" width="100%"><br><br>
				<img src="<?php echo $url.'assets/img/bg1.png'; ?>" width="100%">
			</div>
		</div>